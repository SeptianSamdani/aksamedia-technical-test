        ...
        {isDemoMode && (
          <div className="alert-info">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">Data disimpan di localStorage browser</p>
            </div>
          </div>
        )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {error && (
                <div className="alert-danger">
                  <svg className="w- h-5 text-red-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button type="submit" disabled={loading} className="btn-primary w-full h-10 rounded-lg">
              ...
              <div className="bg-slate-50 dark:bg-gray-700 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <code className="px-2 py-1 bg-white dark:bg-gray-600 rounded font-mono text-blue-600 dark:text-blue-400">admin</code>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-600 dark:text-gray-400">Password:</span>
                    <code className="px-2 py-1 bg-white dark:bg-gray-600 rounded font-mono text-blue-600 dark:text-blue-400">pastibisa</code>
                  </div>
                </div>
              </div>
            </div>
